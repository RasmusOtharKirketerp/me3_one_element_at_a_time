   ...
   static final String IMAGEPATH = "C:\\Users\\Rasmus\\git\\me3_one_element_at_a_time\\me3_one_element_at_a_time\\src\\me3_one_element_at_a_time\\";
	...
	public UniverseData(boolean debug) {
		for (int nyPlanetCounter = 0; nyPlanetCounter < UniverseData.MAX_PLANETS; nyPlanetCounter++) {
			...
			allPlanetsToSun.get(nyPlanetCounter).setPlanetIndex(nyPlanetCounter*1000);
...
//		allPlanetsToSun.get(UniverseData.PLUTO).moonGenerator(5);
	...
	static final String[] planetNames                   = {"Sun",   "Merkur",   "Venus",   "Jorden"
			                                   , "Mars",     "Jupiter", "Saturn"
			                                   , "Uranus"  , "Neptun",  "Pluto"};
	
	static final Color[] planetColor                    = {Color.YELLOW,  Color.MAGENTA, Color.CYAN, Color.GREEN
			                                    ,Color.RED , Color.CYAN, Color.YELLOW
			                                    , Color.LIGHT_GRAY, Color.WHITE, Color.BLUE			
	};
	// ******************************* REAL DATA ************************************************
	// Meanc distance from the sun earth = 1 AU
	static final double[] meanDistanceFromSunAU           = {0.001,  0.39,	0.72,	1
			                                                 , 1.52,	5.20,	9.54
			                                                 ,19.18,	30.06,  39.44 };

	// Speed of the planets in km/s
	static final double[] planetSpeed                       = {0, 47.89,	35.03,	29.79
			                                                   ,24.13,	13.06,	9.64
			                                                   , 6.81,	 5.43,  4.74};
	
	// Planets size in radius
	static final double[] planetSize                        = {1, 0.382,	 0.949,	1
			                                                   ,0.532,	11.209,	9.44
			                                                   ,4.007,	 3.883, 0.180 };
	// ***********************************************************************************************
	// Debug Data
